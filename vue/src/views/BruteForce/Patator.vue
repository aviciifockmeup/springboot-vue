    ...
    <div style="padding: 10px" >
        ...
        <el-row>
            <el-col :span="12">
                ...
                <el-form-item>
                    <header ref="imgRef" style="color:red; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-size:large;">Patator</header>
                </el-form-item>
            </el-col>
        </el-row>
...
<script>
    ...
    export default {
        ...
        methods:{
            GoldenEye() {
                request.post("/patator",this.formData).then(res => {
                    console.log(res)
            ...
            selectService(val){
                ...
                var title = this.$refs.imgRef.innerText
                console.log(title)

                sessionStorage.setItem('temp',title)
